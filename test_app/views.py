...
def loginPage(request):
    ...
    context ={'page':page}
    return render(request, 'test_app/login_register.html', context)
...
def deleteMessage(request, pk):
    ...
    return render(request, 'test_app/delete.html', {'obj':message})
...
def activityPage(request):
      ...
      return render(request, 'test_app/activity.html', {'room_messages':room_messages})